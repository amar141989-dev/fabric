...
public final class Car {
    ...
    public Car(@JsonProperty("id") final String id, @JsonProperty("model") final String model,
               @JsonProperty("owner") final String owner, @JsonProperty("value") final String value) {
        this.id = id;
        this.model = model;
        this.owner = owner;
        this.value = value;
    ...
    public String toString() {
        ...
        + ", model="+model+", owner="+owner+", value="+value+"]";
    }
}
